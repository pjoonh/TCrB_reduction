...
import specfunc_ver10 as spf
import numpy as np


# parameter
# base_path = 'C:/obsdata'    # file path
base_path = "C:/Users/pjoonh/MDFTS/2025"
obsdate = '20250218'
dW = 10                     # image crop
shift = 1500
...
# 9. wavelength calibration
wavelength_list = np.array([4200.674, 4277.528, 4333.561, 4348.064, 4370.753, 4400.986, 4426.001, 4474.759, 4481.811, 4510.733, 4545.052, 4579.35, 4589.898, 
 4657.901, 4726.868, 4735.906, 4764.865, 4806.02, 4879.864, 4889.042, 4965.08, 5017.163, 5037.37, 5330.78, 5341.09, 5400.58, 
...
for img_type in ['piser', 'tcrb']:
    ...
    wavelength_positions = spf.mark_wavelength_positions(img_type, new_folder_path, wavelength_list, a, b, plotCheck=False)
    peaks = spf.detect_many_peaks(img_type, new_folder_path, sigma=1, height_factor=0.05, min_distance=10, plotCheck=False)
    corrected_wavelength_positions = spf.corrected_wavelength_positions(img_type, new_folder_path, wavelength_positions, peaks, peaks_radius=4, plotCheck=True)
