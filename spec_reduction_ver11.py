...
for img_type in ['piser', 'tcrb']:
    ...
    first_matching_wavelength_index = spf.adjust_pixel_positions_with_peaks(img_type, new_folder_path, knownwavelength_to_pixel, all_peaks, tolerance=10, plotCheck=True)
    # second_matching_wavelength_index
