...
for img_type in ['piser', 'tcrb']:
    ...
    # print(median_y_data)
    fwhm_data = spf.compute_fwhm(img_type, new_folder_path, median_y_data, sigma=2, n_segments=15)
    # print(fwhm_data)
    ...
    spectrum_values = spf.trim_spectrum_data(spectrum_values, delete_data=4, plotCheck=False)
    
    ## Arc Extraction
    extracted_spectrum_list = spf.extract_arc_spectrum(img_type, new_folder_path, median_y_data, fwhm_data, plotCheck=False)
    # print(extracted_spectrum_list)
    
    ## Save data to Excel
    spf.save_spectrum_data_to_Excel(img_type, new_folder_path, spectrum_values, extracted_spectrum_list)
