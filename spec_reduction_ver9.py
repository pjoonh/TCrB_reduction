...
import specfunc_ver9 as spf
import numpy as np


# parameter
# base_path = 'C:/obsdata'    # file path
base_path = "C:/Users/pjoonh/MDFTS/2024"
obsdate = '20240828'
dW = 10                     # image crop
shift = 1500
...
# for img_type in ['tcrb']:
    ...
    extracted_spectrum_list = spf.trim_arc_data(extracted_spectrum_list, delete_data=10, plotCheck=True, compare=False)
...
# 9. wavelength calibration
# for img_type in ['piser', 'tcrb']:
#     calibrated_peaks = spf.wavelength_equation(img_type, new_folder_path, sigma=2, plotCheck=False)
